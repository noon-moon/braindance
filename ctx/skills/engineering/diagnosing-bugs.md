...
description: Disciplined diagnosis loop for hard bugs and performance regressions. Use when the user has a bug they can't pin down, or wants a structured debugging approach.
---
